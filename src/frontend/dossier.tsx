...
<title>${safeName} - DoseAtlas Knowledge Map</title>
<style>
...
<p style="margin-top: 30px; color: #94a3b8; font-size: 0.85rem;">Powered by DoseAtlas with Nurse Clippy - ${generatedDate}</p>
</body>
</html>`;
